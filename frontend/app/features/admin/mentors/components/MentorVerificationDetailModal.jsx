...
function MentorVerificationDetailModal({ verificationId, onOpenChange }) {
              ...
              <div className='grid gap-4 sm:grid-cols-2'>
                ...
                <div className='sm:col-span-2'>
                  <DocumentPreview
                    ...
                    url={verification.selfieWithIdUrl}
                  />
                </div>
              </div>
            </>
...
export { MentorVerificationDetailModal }
