...
import type { CatalogGradeApiResponse, CreateGradeRequest, GradeLevelGroupApiResponse, UpdateGradeRequest } from '@/types/api/catalog'
        ...
        <form onSubmit={handleSubmit}>
          <div className="space-y-5 px-7 py-6">
            ...
            <div className="space-y-2">
              <Label className="text-ink text-sm font-medium" htmlFor="levelGroup">Nhóm Cấp bậc</Label>
              <select
                id="levelGroup"
                value={formData.levelGroup}
                onChange={(e) => setFormData({ ...formData, levelGroup: e.target.value as GradeLevelGroupApiResponse })}
            ...
            <div className="space-y-2">
              <Label className="text-ink text-sm font-medium" htmlFor="name">Tên Lớp học / Trình độ</Label>
              <Input
                id="name"
                value={formData.name}
