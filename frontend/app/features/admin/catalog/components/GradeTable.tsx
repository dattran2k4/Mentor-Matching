        ...
        <Table>
          <TableHeader>
            <TableRow className="hover:bg-transparent">
              <TableHead className="w-[100px] text-center font-semibold text-slate-600">ID</TableHead>
              ...
              <TableHead className="w-[150px] text-right font-semibold text-slate-600">Thao tác</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {grades.map((grade) => (
              <TableRow key={grade.id} className="group hover:bg-slate-50/50">
                <TableCell className="text-center font-medium text-slate-500">#{grade.id}</TableCell>
