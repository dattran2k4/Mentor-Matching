        ...
        <div className='flex flex-col gap-5 p-5 md:flex-row md:items-center md:justify-between md:p-6'>
          ...
          <div className='grid grid-cols-3 gap-2 md:min-w-[360px]'>
            <HeaderMetric
              ...
              label='Đánh giá'
              value={mentor.rating !== null ? mentor.rating.toFixed(1) : 'Ch\u01B0a c\xF3'}
            />
            <HeaderMetric
            ...
            <HeaderMetric
              ...
              label='Phản hồi'
              value={mentor.responseTime || 'Ch\u01B0a c\xF4ng khai'}
            />
          </div>
        </div>
...
function ProfileNavItem({ href, icon, label }) {
  return (
    <a
