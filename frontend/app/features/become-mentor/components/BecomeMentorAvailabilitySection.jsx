...
function BecomeMentorAvailabilitySection({
  availabilities,
  availabilityDraft,
  formId,
  isDeleting,
        ...
        <section className='rounded-[24px] border border-slate-200 bg-white p-5 shadow-sm'>
          <div className='border-b border-slate-100 pb-4'>
            <h3 className='text-xl font-semibold text-slate-900'>
              {isEditing ? 'Ch\u1EC9nh s\u1EEDa khung gi\u1EDD' : 'Th\xEAm khung gi\u1EDD m\u1EDBi'}
            </h3>
          </div>
...
function formatRecurringDays(values) {
  const labels = values
    .slice()
...
export { BecomeMentorAvailabilitySection }
