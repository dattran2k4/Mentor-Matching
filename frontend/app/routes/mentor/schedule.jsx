...
const scheduleTips = [
  {
    ...
    description:
      'D\xF9ng cho l\u1ECBch c\u1ED1 \u0111\u1ECBnh m\u1ED7i tu\u1EA7n, ph\xF9 h\u1EE3p h\u1ECDc vi\xEAn h\u1ECDc \u0111\u1EC1u.',
    icon: CalendarDays
  },
  {
    title: 'Khung gi\u1EDD c\u1EE5 th\u1EC3',
    description:
      'D\xF9ng cho t\u0103ng c\u01B0\u1EDDng tr\u01B0\u1EDBc ki\u1EC3m tra ho\u1EB7c \u0111\u1ED5i l\u1ECBch tu\u1EA7n.',
    icon: Clock3
  },
  {
    title: 'Bu\u1ED5i \u0111\xE3 \u0111\u01B0\u1EE3c \u0111\u1EB7t',
    description:
      'C\u1EA7n theo d\xF5i ri\xEAng \u0111\u1EC3 tr\xE1nh hi\u1EC3u availability l\xE0 l\u1ECBch \u0111\xE3 ch\u1ED1t.',
    icon: BookOpen
  }
]
...
function formatSpecificDateLabel(value) {
  if (!value) return 'Ng\xE0y c\u1EE5 th\u1EC3'
...
function mapAvailabilityItem(item) {
  return {
    id: item.id,
...
function getMeetingTypeLabel(booking) {
...
function getBookingNote(booking) {
  ...
  return 'Ch\u01B0a c\xF3 ghi ch\xFA th\xEAm cho bu\u1ED5i h\u1ECDc n\xE0y.'
}
...
function MentorSchedulePage() {
  ...
  const mentorBookingParams = useMemo(
    () => ({
      page: 1,
      size: 100,
      status: bookingStatusFilter === 'ALL' ? void 0 : bookingStatusFilter
    }),
    [bookingStatusFilter]
  )
    ...
    () =>
      (mentorBookingsQuery.data ?? [])
        ...
        .map((booking) => ({
          ...
          subjectLabel: [booking.subjectName, booking.gradeName].filter(Boolean).join(' \xB7 '),
                  ...
                  <div className='flex flex-wrap items-start justify-between gap-4 border-b border-slate-200 pb-4'>
                    <div className='space-y-2'>
                      ...
                      <p className='text-muted text-[0.98rem]'>
                        {session.subjectLabel || 'M\xF4n h\u1ECDc \u0111ang c\u1EADp nh\u1EADt'}
                      </p>
                    </div>
...
function InfoFact({ icon, label, value }) {
  return (
...
export { MentorSchedulePage as default, meta }
