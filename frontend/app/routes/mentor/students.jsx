...
const statusOptions = [
  { label: 'Theo tr\u1EA1ng th\xE1i', value: 'ALL' },
...
const subjectOptions = [
  { label: 'Theo m\xF4n h\u1ECDc', value: 'ALL' },
  { label: 'To\xE1n - L\u1EDBp 9', value: 'TOAN_9' },
  { label: 'To\xE1n - L\u1EDBp 8', value: 'TOAN_8' },
  { label: 'To\xE1n - \xD4n thi l\u1EDBp 10', value: 'ON_THI_10' }
]
function getStudentStatusMeta(student) {
...
function getStudentAvatar(studentName) {
  return studentName
    .split(' ')
    .slice(0, 2)
    .map((part) => part[0])
...
function matchSubjectFilter(student, filter) {
  ...
  return student.recentOffering.includes('\xD4n thi l\u1EDBp 10')
}
function matchStatusFilter(student, filter) {
  if (filter === 'ALL') return true
...
function meta() {
  return [{ title: 'H\u1ECDc vi\xEAn | Mentor' }]
}
                          ...
                          <div className='space-y-3'>
                            <div className='grid gap-3 text-[1.02rem] text-slate-800 md:grid-cols-2'>
                              <p className='flex items-center gap-2'>
                                ...
                                {student.recentOffering.replace(' \xB7 ', ' - ')}
                              </p>
                              <p className='flex items-center gap-2'>
...
export { MentorStudentsPage as default, meta }
