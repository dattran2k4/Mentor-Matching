...
const paymentFilters = [
  ...
  { key: 'PAID', label: '\u0110\xE3 thanh to\xE1n' },
  { key: 'PENDING', label: 'Ch\u1EDD thanh to\xE1n' },
  { key: 'FAILED', label: 'Thanh to\xE1n l\u1ED7i' },
  { key: 'CANCELLED', label: '\u0110\xE3 h\u1EE7y' },
  { key: 'REFUNDED', label: '\u0110\xE3 ho\xE0n ti\u1EC1n' }
]
...
function matchesPaymentSearch(payment, query) {
      ...
      <div className='space-y-6'>
        <div className='grid gap-4 lg:grid-cols-3'>
          <WorkspaceMetricCard
            ...
            helper={`${paidPayments.length} kho\u1EA3n \u0111\xE3 ghi nh\u1EADn`}
            icon={Wallet}
            label='Đã thanh toán'
            tone='success'
          ...
          <WorkspaceMetricCard
            className='rounded-[24px]'
            helper={`${pendingPayments.length} kho\u1EA3n \u0111ang ch\u1EDD learner thanh to\xE1n`}
...
export { MentorEarningsPage as default, meta }
