...
const mentorAvailabilityWeekdayOptions = [
  { label: 'T2', value: '1' },
  { label: 'T3', value: '2' },
  { label: 'T4', value: '3' },
  { label: 'T5', value: '4' },
...
const mentorAvailabilityTimeOptions = Array.from({ length: 32 }, (_, index) => {
...
function isMentorAvailabilityDraftValid(value) {
...
function MentorAvailabilityForm({ className, onChange, value }) {
